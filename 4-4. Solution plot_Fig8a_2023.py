# -*- coding: utf-8 -*-
"""
Created on Sun Nov  5 13:14:20 2023

Fig 8a: Show charing time scheduling at Station 12 
...
f=open('Length_bar_12','r')
a=f.read()
L_bar_12=eval(a)
f.close()

f=open('Color_bar_12','r')
a=f.read()
C_bar_12=eval(a)
f.close()

f=open('Start_time_12','r')
a=f.read()
...
#plt.savefig('Fig8a.png', format="PNG", dpi=1000) 
